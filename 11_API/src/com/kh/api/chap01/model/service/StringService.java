...
public class StringService {
	...
	public void example1() {
		...
		// String Literal로 String 값 지정 시 같은 문자열일 경우 같은 주소를 반환함.
		// (+String Pool)
	...
	public void example2() {
		...
		System.out.println("sb.hashCode() : " + sb.hashCode()); // StringBuffer 클래스는 hashCode()를 오버라이딩 하지 않음.
	...
	public void example3() {
		// String.split(구분자); * 가장 유용한 기능 중 하나! 
		// --> 문자열을 해당 구분자를 기준으로 쪼개어 String[] 배열 형태로 반환
