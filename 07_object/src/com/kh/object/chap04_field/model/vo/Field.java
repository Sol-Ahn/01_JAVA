...
public class Field {
	 ...
	 * */
	 ...
	 public void example1() {
		 ...
		 // 특정한 구역({ }) 내에 생성되는 변수로 지역 변수는 해당 지역에서만 사용 가능
...
//		 num2 = 300; // num2의 지역을 벗어났기 때문에 접근 불가
	 ...
	 private char ch;
	 private double db;
	 /* 생성 : new 를 통해 Heap 영역에 객체(인스턴스) 생성 시 메모리에 할당됨. 
	  * 소멸 : 객체가 소멸 시 소멸됨.
	  * 	--> 객체는 언제 소멸?
...
//	 private final double PI = 3.14;
	 ...
	 // static final == final static (순서 상관 X)
	 
	 // 프로그램 내에서 공유되는 상수
	 public final static double PI = 3.141592;
	 // 왜 public?
	 // 이러한 값들은 어디서든 접근 가능하도록 접근 제한자를 public으로 두는 것이 '규약'으로 정해져 있음. 
