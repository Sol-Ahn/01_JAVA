...
public class ElectronicsService {
	...
	public void insert(Electronics e) { // 매개변수에 다형성 적용
		...
		// index번째 el요소에 전달받은 자식 객체 주소를 추가하고 index를 1 증가시킴.
	...
	// 전자 기기 하나씩의 정보를 반환해야하는 경우,
	// 기기별로 타입이 모두 다르므로 반환형을 다르게 해서 메소드를 작성해야 함.
	// 하지만 오버로딩은 성립하지 않음.(매개변수가 모두 동일)
	// 그래서 메소드를 따로따로 만들어야 하지만 번거롭고 비효율적임.
	// --> 반환형에 다형성을 적용
