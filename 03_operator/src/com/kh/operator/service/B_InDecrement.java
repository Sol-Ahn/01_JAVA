...
public class B_InDecrement {
	// 증감 연산자 : 피연산자를 1 증가 또는 감소시키는 연산자
	...
	public void example1() {
		...
		System.out.println("++num 2회 수행 후 : " + (++num)); // 12
		System.out.println("++num 3회 수행 후 : " + (++num)); // 13
		System.out.println("++num 4회 수행 후 : " + (++num)); // 14
		System.out.println("++num 5회 수행 후 : " + (++num)); // 15
	...
	public void example3() {
		...
		int result1 = a++; // 출력 : 10, a : 11
		// a=11 b=20 c=30 result1=10
		
		int result2 = ++a + b++; // 출력: 31, a: 11, b: 21
		// a=12 b=21 c=30 result2=32
		
		int result3 = (a++) + (--b) + (--c); // 출력: 58, a: 11, b: 19, c:29 
