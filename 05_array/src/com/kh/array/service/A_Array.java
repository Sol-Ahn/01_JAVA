...
public class A_Array {
	...
	public void example1() {
		...
		// 같은 자료형인 변수가 여러 개 필요한 경우, 변수 선언 방법으로는 한계가 있음. 
		...
		// 2. 배열 할당(할당 : 메모리 상에 데이터 저장공간을 확보하는 것)
		// 배열명 = new 자료형[배열크기];
		//                 (== 배열의 칸 수) 
		// *** new 연산자
		// - Heap 영역에 새로운 공간을 할당한다는 의미 
	...
	public void example6() {
		...
		// 입력받은 값만큼의 크기를 갖는 배열 선언 및 할당
		
		int arr[] = new int[size];
		
		// 배열 할당 시 int형 기본값으로 초기화되어 있는지 확인
		for(int i = 0; i < arr.length; i++) {
			System.out.println(arr[i]);
		}
	...
	public void example7() {
		...
		// String(문자열)의 길이만큼의 char 배열 선언 및 할당
