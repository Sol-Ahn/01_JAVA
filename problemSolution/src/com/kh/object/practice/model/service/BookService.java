...
public class BookService {
	public void practice() {
		Book book1 = new Book();
		Book book2 = new Book("자바의 정석", 30000, 0.2, "남궁 성");
		...
		System.out.println("할인된 가격 = " + (book1.getPrice()-(int)(book1.getPrice() * book1.getDiscountRate())));
		System.out.println("도서명 = " + book2.getTitle());
		System.out.println("할인된 가격 = " + (book2.getPrice()-(int)(book2.getPrice() * book2.getDiscountRate())));
