...
public class A_If {
	...
	/* 프로그램의 진행은 위에서 아래, 좌에서 우로 순차적으로 진행됨.
	 ...
	 * 조건문은 대표적으로 if, switch문이 존재함.
	 */

	public void example1() {
		// 단독 if문
		// if문의 조건식이 true이면 중괄호({}, 블록) 내의 코드 수행, false이면 해당 코드를 무시하고 건너뜀.
	...
	public void example2() {
		// if-else문
		/* 조건식이 참인 경우, if문의 코드를 수행함.
		 * 조건식이 거짓인 경우, else문의 코드를 수행함.
		 * 
		 * [표현식]
		 * if(조건식){
		 * 		참인 경우, 실행코드...
	...
	public void example3() {
		// 나이를 입력받아 일반, 청소년, 초등학생 구분 후 요금 받기.
		// 일반 : 1250원   20세   
		// 청소년 : 720원  14세~19세 
		// 초등학생 : 450원  8~13세
		// 유아 : 0원  0~7세
	...
	public void example5() {
		...
		// 95점 이상 A+  94~90점 A  89~85점 B+  84~80점 B  79~75점 C+  74~70점 C  69~90점 D  60점 미만 F
