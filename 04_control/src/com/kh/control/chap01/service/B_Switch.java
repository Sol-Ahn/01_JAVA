...
public class B_Switch {
	// switch문 : if문의 부분집합(일부분)으로 if문은 조건식으로 범위를 지정할 수 있지만, switch문은 딱 떨어지는 값이 조건식으로 작성되어야 함.
	...
	public void example2() {
		// 두 수를 입력받고, 연산자(+-*/%) 중 하나를 입력 받아 두 수를 연산한 결과를 출력
		// 단, 잘못된 연산자 입력 시 
		// "연산자를 잘못 입력하셨습니다." 출력
		...
		default: System.out.println("연산자를 잘못 입력하셨습니다."); return; // return : 호출한 곳으로 돌아가라
		 															// return 코드를 읽는 시점에서 해당 메소드가 종료됨. (메소드 종료 기능으로 사용 가능)
		}
	...
	public void example3() {
		...
		// 사과일 경우 3천원, 바나나일 경우 2천원, 복숭아일 경우 8천원을 출력
		// 단, 잘못 입력한 경우 
		// "해당하는 과일이 없습니다." 출력
