...
public class B_While {
	// while문
	// for문과 달리 반복횟수가 정해져 있지 않고 특정 조건이 false가 될 때까지 반복하는 용도로 사용되는 반복문.
	...
	public void example3() {
		...
		// 0으로 초기화 하는 이유? 0이 int형의 기본값이기 때문임.
		
		boolean flag = true; // while문 반복 제어용 변수
		
		while(flag) { // 결과적으로 true 또는 false가 나오는 것이 조건식
			System.out.print("입력 : ");
			input = sc.nextInt();
			sc.nextLine();
	...
	public void example4() {
		...
		// while문을 중첩해서 사용하는 것은 권장하지 않음.
		// 사용해야 할 경우, 종료 조건을 명확하게 할 것!
	}
	...
	public void example5() {
		...
		String str = null; 
		// null은 참조형 변수의 기본값
		// null의 의미 : 참조하고 있는 값이 없음. "비어 있다" 와는 다른 의미
		
		// String str2 = ""; // 빈 문자열(공백)
		
		do { // 반복문이 최초 한 번은 무조건 실행하겠다는 의미
