...
public class BookService {
	// Book 객체 5개를 매개변수 있는 생성자를 이용하여 생성 후 책 제목을 입력받아
	// 해당 책이 있는지 검색하여 
	// 있으면 Book 객체의 필드정보 출력
	// 없으면 "해당하는 책이 없습니다." 출력
	
	// 필드에 Scanner 객체를 선언하여 클래스 내부에서 모두 사용가능하게 함.
	...
	public void searchBookV1() {
		...
		Book book2 = new Book("C언어의 정석", 50000, 0.2, "김철수");
...
//		Book book5 = new Book("해리포터", 12000, 0.3, "조앤K롤링");
		...
		books[1] = new Book("C언어의 정석", 50000, 0.2, "김철수");
		...
		Book[] books = {      
				...
				new Book("C언어의 정석", 50000, 0.2, "김철수"),
		...
		for(int i = 0; i < books.length; i++) {
		  ...
		  // books의 i번째 인덱스 요소의 title이 입력받은 값과 같다면?
